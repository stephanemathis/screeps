...
exports.tick = tick;
function createBuildingIfNecessary() {
...
exports.getNextStructure = getNextStructure;
function countExistingStructures(struct, room) {
    var result = room.find(FIND_MY_STRUCTURES, {
        filter: { structureType: struct }
    });
    return result.length;
}
exports.countExistingStructures = countExistingStructures;
function getMaxStructureNumber(struct, level, room) {
...
function getPositionForStructure(struct, room) {
    ...
    if (struct == STRUCTURE_CONTAINER) {
        ...
        for (var i = 0; i < sources.length; i++) {
            ...
            var numberOfContainer = result.filter(function (p) {
...
exports.getPositionForStructure = getPositionForStructure;
