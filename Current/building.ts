...
export function getNextStructure(room)
{
...
export function countExistingStructures(struct, room)
{
...
export function getMaxStructureNumber(struct, level, room)
{
...
export function getPositionForStructure(struct, room)
{
